...
\usepackage{graphics,subfigure,epsfig,float,pdflscape,booktabs,array}
%
\usepackage{cleveref}
\usepackage{appendix}
\usepackage{amsmath}
...
\def\Registered{\raisebox{1ex}{\kern-.1em\setbox\@tempboxa\hbox{\footnotesize$\bigcirc$}\hbox to 0pt{\hbox to\wd\@tempboxa{\hss\tiny R\hss}\hss}\box\@tempboxa\kern-.1em}}
...
[fig1 : Tractrix curve]
[fig2 : Tractrix on multiple links]
...
[fig3 : Link avoiding multiple obstacles]
...
\begin{align}
f(\textbf{x})= f(x,y):\quad\vert \frac{x-x_c}{a} \vert^n+\vert \frac{y-y_c}{b} \vert^n-1=0
\end{align}

[fig4 : ( What are super-ellipses? Duct as a combination of super-ellipses)]
...
[fig5 : Motion through the duct as a combination of super-ellipses]

[fig6 : To show how the link gets pulled into the duct when started off the duct]
...
[fig7] : Duct represented by stitched quadrilaterals

[fig8] : Example where the classification problem returns complex solutions
...
[fig9] : The $\xi$ function, $\chi$ function
...
[fig10] : Example of constrained motion with stitched quadrilaterals

[fig10b] : Constraint equation's gradient
...
[fig11] : Example of analytical duct
...
[fig12] : Example of motion through analytical duct
