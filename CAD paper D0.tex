...
\begin{itemize}
	\item Analytical curves and cylinders would require a in-out classifier which is very much computationally involving. Real time implementation with this , even with near analytical formaulations of the in-out function is not possible.
	\item The tractrix can pass through a certain curve based on it's physical dimensions. We show the dimension of the largest link which  can pass around a given curve is dependent on the local curvature of the curve or surface it is negotiating. This will have a mathematical proof. half page
	\item Since the objective function and the constraints are not affine, some issues with scaling may occur. we will discuss about these too. 2-3 sentences.
\end{itemize}
...
\begin{figure}[ht!]
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{Tractrix emulating the motion of a bicycle chain on paper, $\nu=0.95$}
